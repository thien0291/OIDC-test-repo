...
ActiveRecord::Schema[7.0].define(version: 2023_09_05_102215) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "access_passes", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "package_name", default: "1 day", null: false
  ...
  create_table "articles", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "thumbnail", default: "https://mdbcdn.b-cdn.net/img/new/standard/city/018.jpg"
    t.string "author", default: "Louis Theroux"
  end

  create_table "credit_tokens", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id", null: false
    t.string "provider", default: "pressingly"
    t.string "secret_token", null: false, comment: "The secret token that is used to access the credit token."
    t.decimal "threshold", precision: 12, scale: 6, default: "5.0", null: false, comment: "The amount of credit that is available to the user."
    t.datetime "expired_at", null: false, comment: "The date and time when the credit token expires."
    t.datetime "cancelled_at", comment: "The date and time when the credit token was cancelled."
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["secret_token"], name: "index_credit_tokens_on_secret_token", unique: true
    t.index ["user_id"], name: "index_credit_tokens_on_user_id"
  end
  ...
  create_table "transactions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.uuid "credit_token_id"
    t.decimal "amount", precision: 12, scale: 6, default: "0.0", null: false
    t.string "currency", default: "USD", null: false
    t.string "related_object_type", null: false
    t.uuid "related_object_id", null: false
    t.index ["credit_token_id"], name: "index_transactions_on_credit_token_id"
    t.index ["related_object_type", "related_object_id"], name: "index_transactions_on_related_object"
  ...
  add_foreign_key "credit_tokens", "users"
