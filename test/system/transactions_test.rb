...
class TransactionsTest < ApplicationSystemTestCase
  ...
  test "should create transaction" do
    ...
    fill_in "Extra info", with: @transaction.extra_info
    fill_in "Provider", with: @transaction.provider
    fill_in "Provider transaction", with: @transaction.provider_transaction_id
